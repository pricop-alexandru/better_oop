#include "content.h"
PlayField::PlayField(sf::RenderWindow& win) : window(win), clearedLines(0), gameOver(false) { //avem si un subtil stadiu al jocului, also pentru verificarea ecranului de final se modifica usor din false in true
